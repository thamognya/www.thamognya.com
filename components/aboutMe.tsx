    ...
    <>
            <div className="container mx-auto px-11">
                <p className="leading-tight max-w-5xl mx-auto text-3xl lg:text-3xl text-bg-fg dark:text-bg-bg">
                    ...
                    kernels, and machine learning. I am a proxy maintainer and contributor at Gentoo and I hope to contribute to more opensource.
                </p>
            </div>
    </>
    )
...
const AboutLeft = () => {
    // testing box
    return (
        <Box>tmp add dog model here</Box>
    );
}
