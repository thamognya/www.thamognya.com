            ...
            <section className="flex flex-col bg-bg-bg py-20 text-3xl md:text-4 h-screen md:h-screen">
                <div className="container mx-auto px-11">
                    <p className="leading-tight max-w-5xl mx-auto text-4xl lg:text-4xl text-bg-fg">
                        ...
                        HighSchool student who likes Operating System, kernels,
                        and Machine Learning. Currently I am an proxy maintainer
                        and contributor at Gentoo. Additionally I also am an tor
